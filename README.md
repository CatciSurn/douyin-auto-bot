...
1. 在Master_Start.bat中修改你的虚拟机的相关信息，包括虚拟机名字、虚拟机用户名、虚拟机登录密码。
2. 双击同目录下的"Master_Start.bat"
3. 切换到虚拟机，点开到需要点赞的视频。按方向键“下”滑到最后一条。
4. 将鼠标准心放在点赞按钮上，放好了之后按下回车键。
5. 设定好KPI，按下回车键，你就可以把虚拟机切换到后台去做你想做的事情了。
